{'class': [{'class': [],
            'func': [{'args': ['self'], 'defaults': [], 'name': 'BINARY_OnNEWCIBNPasspodFailure'},
 ...
 'import': ['app', 'dbg', 'm2netm2g', 'ime', 'systemSetting', 'uiScriptLocale', 'ui', 'localeInfo', 'uiCommon', 'snd', 'serverCommandParser', '__builtin__', 'serverInfo', 'wndMgr', 'constInfo', 'ServerStateChecker', 'musicInfo', 'time'],
