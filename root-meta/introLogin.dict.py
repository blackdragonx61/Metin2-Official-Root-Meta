{'class': [{'class': [],
            ...
            'var': [{'name': 'SERVER_FLAG_IMAGE_PATH_DICT',
                    ...
                    {'name': 'STATE_IMAGE_PATH', 'type': 'tuple', 'value': ('', 'locale/hu/ui/login/choise_new.tga', 'locale/hu/ui/login/choise_special.tga', 'locale/hu/ui/login/choise_close.tga', 'locale/hu/ui/login/choise_close.tga')},
                    {'name': 'STATE_IMAGE_TOOLTIP', 'type': 'tuple', 'value': ('', '\xdaJ', 'SPECI\xc1LIS', 'LEZ\xc1RT', 'LEZ\xc1RT')},
