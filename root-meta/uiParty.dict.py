{'class': [{'class': [],
           ...
           {'class': [],
            'func': [{'args': ['self', 'distributionMode'], 'defaults': [], 'name': 'ChangePartyParameter'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': '__init__'}],
            'import': [],
            'var': [{'name': 'BUTTON_NAME', 'type': 'tuple', 'value': ('Restore everything.', 'Delete Group', 'Leave group')}, {'name': '__doc__', 'type': 'NoneType', 'value': None}, {'name': '__module__', 'type': 'str', 'value': 'uiParty'}, {'name': '__qualname__', 'type': 'str', 'value': 'PartyMenu'}]},
           {'class': [{'class': [],
            ...
            'var': [{'name': 'AFFECT_STRING_DICT',
                     'type': 'dict',
                     'value': {0: <cyfunction SA.<locals>.f at 0x0832A030>,
                               1: <cyfunction SA.<locals>.f at 0x0830BEA0>,
                               2: <cyfunction SA.<locals>.f at 0x0832A0E0>,
                               3: <cyfunction SA.<locals>.f at 0x0830BF50>,
                               4: <cyfunction SA.<locals>.f at 0x0832A088>,
                               5: <cyfunction SA.<locals>.f at 0x0830BEF8>,
                               6: <cyfunction SA.<locals>.f at 0x0830BFA8>,
                               7: <cyfunction SNA.<locals>.f at 0x0832A138>,
                               8: <cyfunction SNA.<locals>.f at 0x0832A190>}},
                    ...
                    {'name': 'STATE_NAME_DICT', 'type': 'dict', 'value': {2: 'Constitute as Attacker.', 3: 'Constitute as blade fighter.', 4: 'Constitute as Blocker.', 5: 'Constitute as Skill Master.', 6: 'Constitute as Berserker.', 7: 'Constitute as Defender.'}},
