{'class': [{'class': [],
           ...
           {'class': [],
            'func': [{'args': ['self', 'distributionMode'], 'defaults': [], 'name': 'ChangePartyParameter'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': '__init__'}],
            'import': [],
            'var': [{'name': '__doc__', 'type': 'NoneType', 'value': None}, {'name': '__module__', 'type': 'str', 'value': 'uiParty'}, {'name': '__qualname__', 'type': 'str', 'value': 'PartyMenu'}]},
           {'class': [{'class': [],
            ...
            'func': [{'args': ['self'], 'defaults': [], 'name': 'Destroy'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': 'HideStateButton'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': '__init__'}],
            'import': [],
            'var': [{'name': 'BOARD_COLOR', 'type': 'int', 'value': 2130706432},
 ...
 'var': [{'name': 'LEADERSHIP_SKILL_ICON_X_SPACING', 'type': 'int', 'value': 23},
         {'name': 'LEADERSHIP_SKILL_ICON_X_START', 'type': 'int', 'value': 110},
         {'name': '__doc__', 'type': 'NoneType', 'value': None},
         {'name': '__name__', 'type': 'str', 'value': 'uiParty'},
