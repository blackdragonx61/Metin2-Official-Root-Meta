{'class': [{'class': [],
            ...
            'import': [],
            'var': [{'name': 'M2JOBLIST', 'type': 'dict', 'value': {0: 'Warrior', 1: 'Ninja', 2: 'Sura', 3: 'Shaman', 4: 'Lycan'}},
                    {'name': 'PARTY_RANK_BOARD_NAME', 'type': 'dict', 'value': {0: ('Overall Rankings', 'Time', 'Members'), 1: ('Weekly Rankings', 'Time', 'Members'), 2: ('Previous Rankings', 'Time', 'Members')}},
