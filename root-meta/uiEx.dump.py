...
class Window:
ClearDictionary,		<cyfunction Window.ClearDictionary at 0x3DBDB298>
	arg0: self
...
__del__,		<cyfunction Window.__del__ at 0x3DBDB348>
	arg0: self
...
InsertChild,		<cyfunction Window.InsertChild at 0x3DBDB1E8>
	arg0: self
	arg1: name
	arg2: child
...
Skipped: unbound method cython_function_or_method object must be called with Window instance as first argument (got nothing instead)
GetChild,		<cyfunction Window.GetChild at 0x3DBDB138>
	arg0: self
	arg1: name

submodule.GetChild
Skipped: unbound method cython_function_or_method object must be called with Window instance as first argument (got nothing instead)
_Window__LoadSkin,		<cyfunction Window.__LoadSkin at 0x3DBDB240>
	arg0: self
	arg1: fileName

submodule._Window__LoadSkin
Skipped: unbound method cython_function_or_method object must be called with Window instance as first argument (got nothing instead)
IsChild,		<cyfunction Window.IsChild at 0x3DBDB190>
	arg0: self
	arg1: name

submodule.IsChild
Skipped: unbound method cython_function_or_method object must be called with Window instance as first argument (got nothing instead)
__init__,		<cyfunction Window.__init__ at 0x3DBDB2F0>
	arg0: self
	arg1: skinFileName
	default: 
