{'class': [{'class': [],
            'func': [{'args': ['self'], 'defaults': [], 'name': 'Accept'},
                     ...
                     {'args': ['self', 'slotIndex'], 'defaults': [], 'name': '__ShowToolTip_FreeItem'},
