{'class': [{'class': [],
            'func': [{'args': ['self'], 'defaults': [], 'name': 'Close'}, {'args': ['self'], 'defaults': [], 'name': 'OnUpdate'}, {'args': ['self', 'layer'], 'defaults': ['TOP_MOST'], 'name': '__init__'}],
            'import': [],
            'var': [{'name': 'BarHeight', 'type': 'int', 'value': 45},
           ...
           {'class': [],
            'func': [{'args': ['self', 'f'], 'defaults': [], 'name': 'AddOnCloseEvent'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': 'OnInput'},
            ...
            'var': [{'name': 'QUEST_BUTTON_MAX_NUM', 'type': 'int', 'value': 8},
                    ...
                    {'name': 'QuestCurtain', 'type': 'QuestCurtain', 'value': <uiQuest.QuestCurtain object at 0x1D6B81D0>},
 ...
 'func': [],
 'import': ['app', 'dbg', 'm2netm2g', 'event', 'grp', 'localeInfo', '__builtin__', 'sys', 'grpImage', 'wndMgr', 'ui', 'time'],
