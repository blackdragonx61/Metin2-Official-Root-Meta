{'class': [{'class': [],
            ...
            'var': [{'name': 'BarHeight', 'type': 'int', 'value': 160},
                    ...
                    {'name': 'DEFAULT_BAR_HEIGHT', 'type': 'float', 'value': 60.0},
                    {'name': 'OnDoneEventList', 'type': 'list', 'value': []},
                    {'name': '_QuestCurtain__curtain_speed_correction_value', 'type': 'member_descriptor', 'value': <member '_QuestCurtain__curtain_speed_correction_value' of 'QuestCurtain' objects>},
                    {'name': '__doc__', 'type': 'NoneType', 'value': None},
                    {'name': '__module__', 'type': 'str', 'value': 'uiQuest'},
                    {'name': '__qualname__', 'type': 'str', 'value': 'QuestCurtain'},
                    {'name': '__slots__', 'type': 'tuple', 'value': ('__curtain_speed_correction_value',)}]},
           {'class': [],
           ...
           {'class': [],
            'func': [{'args': ['self', 'f'], 'defaults': [], 'name': 'AddOnCloseEvent'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': 'CloseSelfWithHideCurtain'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': 'MakeCancelButton'},
                     ...
                     {'args': ['self', 'n'], 'defaults': [], 'name': 'MakeQuestionWithCancelButton'},
                     {'args': ['self', 'one', 'n'], 'defaults': [], 'name': 'NextQuestPageEvent'},
                     {'args': ['self', 'file_name'], 'defaults': [], 'name': 'OnBackgroundImage'},
                     ...
                     {'args': ['self'], 'defaults': [], 'name': 'OnPressCancelButton'},
            ...
            'var': [{'name': 'QUEST_BUTTON_MAX_NUM', 'type': 'int', 'value': 8},
                    {'name': 'QUEST_CUT_WIDTH_LIMIT', 'type': 'int', 'value': 110},
                    {'name': 'QuestCurtain', 'type': 'QuestCurtain', 'value': <uiQuest.QuestCurtain object at 0x2D122238>},
 ...
 'func': [],
 'import': ['app', 'dbg', 'm2netm2g', 'playerm2g2', 'event', 'grp', 'localeInfo', '__builtin__', 'sys', 'quest', 'grpImage', 'wndMgr', 'ui', 'time'],
 'var': [{'name': 'QUEST_BOARD_IMAGE_DIR', 'type': 'str', 'value': 'd:/ymir work/ui/game/questboard/'},
         {'name': 'QUEST_BUTTON_WIDTH_ADJUSTMENT_VALUE', 'type': 'float', 'value': 2.8},
         {'name': '__doc__', 'type': 'NoneType', 'value': None},
