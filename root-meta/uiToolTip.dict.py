{'class': [{'class': [],
 ...
 'import': ['shop', 'mail', 'chatm2g', 'app', 'dbg', 'playerm2g2', 'uiRefine', 'skill', 'constInfo', 'grp', 'chr', 'mouseModule', 'safebox', 'localeInfo', 'exchange', '__builtin__', 'background', 'wndMgr', 'guild', 'uiDragonSoul', 'item', 'uiMonsterCard', 'ui', 'guildbank', 'grpText', 'nonplayer'],
