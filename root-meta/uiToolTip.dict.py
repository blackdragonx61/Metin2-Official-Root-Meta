{'class': [{'class': [],
           ...
           {'class': [],
            'func': [{'args': ['self', 'itemVnum', 'metinSlot', 'attrSlot', 'pet_info'], 'defaults': [], 'name': 'AddHyperLinkPetItemData'},
                     {'args': ['self', 'itemVnum', 'metinSlot', 'attrSlot', 'flags', 'unbindTime', 'window_type', 'slotIndex', 'refine_element', 'set_value'], 'defaults': [0, 0, 0, 1, -1, None, 0], 'name': 'AddItemData'},
                     {'args': ['self', 'itemVnum', 'itemDesc', 'itemSummary', 'metinSlot', 'attrSlot'], 'defaults': [], 'name': 'AddItemData_Offline'},
                     {'args': ['self', 'itemVnum', 'metinSlot', 'attrSlot', 'type', 'refine_element', 'set_value'], 'defaults': [0, None, 0], 'name': 'AddRefineItemData'},
