{'class': [{'class': [],
           ...
           {'class': [],
            'func': [{'args': ['self', 'itemVnum', 'metinSlot', 'attrSlot', 'pet_info'], 'defaults': [], 'name': 'AddHyperLinkPetItemData'},
                     ...
                     {'args': ['self', 'itemVnum', 'metinSlot', 'attrSlot', 'type', 'refine_element'], 'defaults': [0, None], 'name': 'AddRefineItemData'},
                     ...
                     {'args': ['self', 'oriitemVnum', 'window_type', 'slotIndex', 'metinSlot', 'refine_element'], 'defaults': [], 'name': '__AppendAcceItemAffectInformation'},
                     ...
                     {'args': ['self', 'refine_element'], 'defaults': [], 'name': '__AppendAttackPowerInfo'},
 ...
 'import': ['shop', 'mail', 'app', 'dbg', 'playerm2g2', 'uiRefine', 'skill', 'constInfo', 'grp', 'chr', 'mouseModule', 'safebox', 'localeInfo', 'exchange', '__builtin__', 'background', 'wndMgr', 'guild', 'uiDragonSoul', 'item', 'uiMonsterCard', 'ui', 'guildbank', 'grpText', 'nonplayer'],
